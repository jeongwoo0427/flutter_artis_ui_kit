...
class AFloatingNavigationBar extends StatefulWidget {
  ...
  @override
  State<AFloatingNavigationBar> createState() => _MainMenuBottomFloatingBarState();
}

class _MainMenuBottomFloatingBarState extends State<AFloatingNavigationBar> with TickerProviderStateMixin {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: themeData.colorScheme.shadow.withOpacity(0.17), blurRadius: 35,spreadRadius: 1, offset: const Offset(0, 7))]
            ),
            child: Column(
              ...
              children: [
                Container(
                  height: 5,
                  width: widget.itemWidth*navigationItems.length,
                  child: Stack(
                    children: [
                      AnimatedPositioned(
                          left: _getCurrentCursorPosition(widget.itemWidth, _cursorWidth, navigationItems.length, widget.selectedIndex),
                          top: 0,
                          bottom: 0,
  ...
  Widget _getNavigationItem(int index, AFloatingNavigationItem item, Function(int index) onTap) {
    ThemeData themeData = Theme.of(context);
